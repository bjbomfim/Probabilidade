# É utilizada quando se consideram extrações aleatórias, sem reposição, de uma população dividida 
# segundo dois atributos.

# Exemplo 1, continuação) Um banco de investimentos possui 20 clientes com mais de 𝑅$ 100 𝑚𝑖𝑙hõ𝑒𝑠 
# aplicados. Destes, 5 moram fora do Brasil:
...
# Exemplo 2) Uma urna contém 15 bolas, sendo 10 brancas e 5 vermelhas. Uma amostra de extensão 4, 
# não ordenada e sem reposição, é retirada ao acaso da urna. Determine qual é a probabilidade de 
# que três bolas sejam vermelhas.
dhyper (3, 5, 10, 4)
